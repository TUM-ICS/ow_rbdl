...
#ifdef OW_RBDL_USE_ROS_URDF_LIBRARY
...
typedef urdf::LinkConstSharedPtr ConstLinkPtr;
...
OW_RBDL_DLLAPI bool URDFReadFromFile (const char* filename, Model* model, bool floating_base, bool verbose) {
...
OW_RBDL_DLLAPI bool URDFReadFromString (const char* model_xml_string, Model* model, bool floating_base, bool verbose) {
    assert (model);
