...
#ifndef OW_RBDL_CONSTRAINTS_H
#define OW_RBDL_CONSTRAINTS_H
...
struct OW_RBDL_DLLAPI CustomConstraint;
 ...
 * before it can be used in \link ow_rbdl::ForwardDynamicsContacts
 * ForwardDynamicsContacts \endlink.
 */
struct OW_RBDL_DLLAPI ConstraintSet {
  ConstraintSet() :
