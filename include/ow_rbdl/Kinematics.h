...
#ifndef OW_RBDL_KINEMATICS_H
#define OW_RBDL_KINEMATICS_H
 ...
 */
OW_RBDL_DLLAPI void UpdateKinematics (Model &model,
 ...
 * \param QDDot the generalized accelerations of the joints
 */
OW_RBDL_DLLAPI void UpdateKinematicsCustom (Model &model,
    const Math::VectorNd *Q,
    const Math::VectorNd *QDot,
    const Math::VectorNd *QDDot
    );
 ...
 */
OW_RBDL_DLLAPI Math::Vector3d CalcBodyToBaseCoordinates (
    Model &model,
    const Math::VectorNd &Q,
 ...
 */
OW_RBDL_DLLAPI Math::Vector3d CalcBaseToBodyCoordinates (
    Model &model,
    const Math::VectorNd &Q,
    unsigned int body_id,
 ...
 * to body coordinates.
 */
OW_RBDL_DLLAPI Math::Matrix3d CalcBodyWorldOrientation (
    Model &model,
    const Math::VectorNd &Q,
 ...
 *
 */ 
OW_RBDL_DLLAPI void CalcPointJacobian (Model &model,
    const Math::VectorNd &Q,
    unsigned int body_id,
 ...
 *
 */ 
OW_RBDL_DLLAPI void CalcPointJacobian6D (Model &model,
    const Math::VectorNd &Q,
    unsigned int body_id,
    const Math::Vector3d &point_position,
    Math::MatrixNd &G,
 ...
 */
OW_RBDL_DLLAPI Math::Vector3d CalcPointVelocity (
    Model &model,
    const Math::VectorNd &Q,
    const Math::VectorNd &QDot,
    unsigned int body_id,
