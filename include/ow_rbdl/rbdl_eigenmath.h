...
#ifndef OW_RBDL_EIGENMATH_H
#define OW_RBDL_EIGENMATH_H
...
#define OW_RBDL_TEMPLATE_DLLAPI
#else
#define OW_RBDL_TEMPLATE_DLLAPI OW_RBDL_DLLAPI
#endif

class OW_RBDL_TEMPLATE_DLLAPI Vector2_t : public Eigen::Vector2d
{
  public:
...
class OW_RBDL_TEMPLATE_DLLAPI Vector3_t : public Eigen::Vector3d
{
  public:
...
class OW_RBDL_TEMPLATE_DLLAPI Matrix3_t : public Eigen::Matrix3d
{
  public:
...
class OW_RBDL_TEMPLATE_DLLAPI Vector4_t : public Eigen::Vector4d
{
  public:
...
class OW_RBDL_TEMPLATE_DLLAPI SpatialVector_t : public Eigen::Matrix<double, 6, 1>
{
  public:
...
class OW_RBDL_TEMPLATE_DLLAPI SpatialMatrix_t : public Eigen::Matrix<double, 6, 6>
{
  public:
