...
#ifndef OW_RBDL_MODEL_H
#define OW_RBDL_MODEL_H
...
#include "ow_rbdl/Joint.h"
#include "ow_rbdl/Body.h"
...
#ifdef EIGEN_CORE_H
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(ow_rbdl::Joint)
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(ow_rbdl::Body)
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(ow_rbdl::FixedBody)
#endif

/** \brief Namespace for all structures of the ow_rbdl library
*/
namespace ow_rbdl {
 ...
 *
 * RBDL stores the model internally in the \link ow_rbdl::Model
 * Model Structure\endlink. For each \link ow_rbdl::Body Body
 ...
 * algorithms.
 * 
 * There are multiple ways of creating \link ow_rbdl::Model Models\endlink for RBDL:
 *
 ...
 *
 * The construction of \link ow_rbdl::Model Model Structures
 * \endlink makes use of carefully designed constructors of the classes
 * \link ow_rbdl::Body Body \endlink and \link
 * ow_rbdl::Joint Joint \endlink to ease the process of
 * creating articulated models.
 *
 * \link ow_rbdl::Body Bodies \endlink are created by calling one
 * of its constructors. Usually they are created by specifying the mass,
 * center of mass and the inertia at the center of mass. 
 * \link ow_rbdl::Joint Joints \endlink are similarly created and is
 ...
 * ow_rbdl::Model::AddBody() or 
 * ow_rbdl::Model::AppendBody().
 *
 ...
 * ow_rbdl::Addons::LuaModelReadFromFile \endlink, and \link
 * ow_rbdl::Addons::LuaModelReadFromFileWithConstraints \endlink.

 * \section modeling_urdf Using URDF
 *
 * For this see the documentation see \link
 * ow_rbdl::Addons::URDFReadFromFile \endlink.
 */
