...
#ifndef OW_RBDL_SPATIALALGEBRAOPERATORS_H
#define OW_RBDL_SPATIALALGEBRAOPERATORS_H
...
struct OW_RBDL_DLLAPI SpatialRigidBodyInertia {
 ...
 */
struct OW_RBDL_DLLAPI SpatialTransform {
  SpatialTransform() :
...
/* OW_RBDL_SPATIALALGEBRAOPERATORS_H*/
#endif
