...
#ifndef OW_RBDL_JOINT_H
#define OW_RBDL_JOINT_H
 ...
 * ow_rbdl::JointTypeSpherical. When using this joint type the
...
struct OW_RBDL_DLLAPI CustomJoint {
  CustomJoint() 
  { }
  virtual ~CustomJoint() {};
