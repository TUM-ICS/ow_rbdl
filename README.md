...
This package contains a modified version of the RBDL library wrapped in a ROS package. For best performance it should be compiled in "release" mode.

Original source:   https://github.com/rbdl/rbdl
